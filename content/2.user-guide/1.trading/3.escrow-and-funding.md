...
sequenceDiagram
  participant D as DeFlow application
  participant F as EscrowFactory contract
  participant E as Deal escrow
  participant B as Buyer wallet
  participant S as Seller wallet
  D->>F: Deploy accepted deal
  F->>E: Deploy complete CREATE2 instance
  B->>E: Approve and deposit TestUSDC
  S->>E: Approve and deposit TestUSDC
  E-->>D: Emit funding events
```
