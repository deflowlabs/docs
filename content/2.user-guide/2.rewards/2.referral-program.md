...
flowchart LR
  A[Attributed participant settles] --> B[Calculate the qualifying platform fee]
  B --> C[Create the referral commission]
  C --> D[Add the fee-credit share]
  C --> E[Add the TestUSDC share]
```
