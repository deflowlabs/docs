...
Settlement is the final stage of the deal lifecycle. When both parties have fully funded the escrow, the smart contract executes an atomic swap, delivering assets to both sides in a single, irreversible transaction. This page explains the settlement process, finality guarantees, and what happens after a deal settles.
